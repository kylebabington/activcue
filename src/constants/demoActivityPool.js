...
export const DEMO_ACTIVITY_POOL = Object.freeze([
  {
    "id": "draw-a-picture",
    "slug": "draw-a-picture",
    "title": "Draw a picture",
    "summary": "Get paper and draw whatever you feel like.",
    "estimatedMinutes": 20,
    "steps": [
  ...
  },
  {
    ...
    "slug": "color-a-page",
    "title": "Color a page",
    "summary": "Pick a coloring page and fill it in section by section.",
    "estimatedMinutes": 20,
    "steps": [
  ...
  },
  {
    ...
    "slug": "build-a-tower",
    "title": "Build a tower",
    "summary": "Dump out your blocks and build the tallest tower you can.",
    "estimatedMinutes": 20,
    "steps": [
  ...
  {
    "id": "the-lost-shell-signal",
    "slug": "the-lost-shell-signal",
  ...
  {
    "id": "tiny-bakery-counter",
    "slug": "tiny-bakery-counter",
  ...
  {
    "id": "the-quiet-clue-room",
    "slug": "the-quiet-clue-room",
  ...
  {
    "id": "stuffed-pet-clinic",
    "slug": "stuffed-pet-clinic",
  ...
  },
  {
    ...
    "slug": "do-a-puzzle",
    "title": "Do a puzzle",
    "summary": "Dump the pieces, find the edges, and fill in the middle.",
    "estimatedMinutes": 20,
    "steps": [
      "Dump the pieces.",
  ...
  {
    "id": "make-a-reading-nook",
    "slug": "make-a-reading-nook",
    "title": "Make a reading nook",
    "summary": "Pick a book, make a comfy spot, and read for a little while.",
    "estimatedMinutes": 20,
    "steps": [
      "Pick a book.",
  ...
  {
    "id": "play-a-simple-card-game",
    "slug": "play-a-simple-card-game",
    "title": "Play a simple card game",
    "summary": "Get your cards, shuffle and deal, and play one round.",
    "estimatedMinutes": 20,
    "steps": [
      "Get your cards.",
      "Shuffle and deal.",
  ...
  {
    "id": "downtown-map-maker",
    "slug": "downtown-map-maker",
  ...
  {
    "id": "museum-of-lost-exhibits",
    "slug": "museum-of-lost-exhibits",
  ...
  {
    "id": "nature-magic-weather-map",
    "slug": "nature-magic-weather-map",
  ...
  {
    "id": "living-room-circus-show",
    "slug": "living-room-circus-show",
  ...
  {
    "id": "hallway-map-courier",
    "slug": "hallway-map-courier",
  ...
  {
    "id": "build-a-cozy-fort",
    "slug": "build-a-cozy-fort",
  ...
  {
    "id": "make-play-doh-shapes",
    "slug": "make-play-doh-shapes",
    "title": "Make Play-Doh shapes",
    "summary": "Open your Play-Doh and make balls, snakes, cookies, or one finished shape.",
    "estimatedMinutes": 20,
    "steps": [
      "Open your Play-Doh.",
  ...
  {
    "id": "ball-play-outside",
    "slug": "ball-play-outside",
    "title": "Ball play outside",
    "summary": "Grab a ball, go to a safe play space, and kick, throw, or bounce.",
    "estimatedMinutes": 20,
    "steps": [
      "Grab a ball.",
  ...
  {
    "id": "phone-photography-challenge",
  ...
  {
    "id": "neighborhood-invention-fair",
  ...
  {
    "id": "secret-animal-rescue-cleanout",
